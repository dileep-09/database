...
INSERT INTO `tbladmin` VALUES (1,'admin','admin@123','admin@gmail.com','2021-01-06 00:34:45');
...
CREATE TABLE `tblbuyer` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8899 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tblbuyer` VALUES (8898,'Sagar Kharmale','kharmalesagar@gmail.com','8587745620','Malwadi,Pune.','sagar','sagar@123','2022-12-11 06:04:25','2022-12-11 13:55:17');
...
INSERT INTO `tblcaptcha` VALUES ('18997');
...
INSERT INTO `tblfeedback` VALUES (3,'Kishor Balasaheb Kadam','9404308673','kadamk329@yahoo.com','Feedback','Awesome farmer buddy portal, got lots of knowledge.','2022-12-11 09:38:16','2022-12-11 15:08:16');
...
INSERT INTO `tblsellcrops` VALUES (5903,'Kishor Balasaheb Kadam','kadamk329@yahoo.com','9404308673','Bhalawani, Ahmednagar,Maharashtra,India,414103','Wheat Crop','Its a sarbati type wheat, its very good for making roti as well eat to sweet.','2500 KG','Sagar Kharmale','Accept Crop','2022-12-11 08:43:12','2022-12-11 14:23:14');
...
-- Dump completed on 2023-12-30 19:29:25
